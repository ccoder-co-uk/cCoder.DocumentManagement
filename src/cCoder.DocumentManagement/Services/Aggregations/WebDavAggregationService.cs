...
internal partial class WebDavAggregationService(
            ...
            try
            {
                switch (request.Method.ToUpperInvariant())
                {
                    ...
                    case "GET":
                        ...
                        DmsResult getResult = dmsInstanceOperationsExposure.Get(
                            path: path.FullPath,
                            version: getVer);
                    ...
                    case "PUT":
                        ...
                        await dmsInstanceOperationsExposure.SaveAsync(
                            path: path.FullPath,
                    ...
                    case "MOVE":
                        await dmsInstanceOperationsExposure.MoveAsync(
                            oldPath: path.FullPath,
                            newPath: ResolveDestinationPathDmsProcessingRequest(request: request, appId: appId).FullPath
                        );
                        return CreateDmsProcessingResponse(
                            body: Stream.Null,
                            hasBody: false,
                    ...
                    case "COPY":
                        await dmsInstanceOperationsExposure.CopyAsync(
                            oldPath: path.FullPath,
                            newPath: ResolveDestinationPathDmsProcessingRequest(request: request, appId: appId).FullPath
                        );
                        return CreateDmsProcessingResponse(
                    ...
                    case "DELETE":
                        await dmsInstanceOperationsExposure.DropAsync(
                            path: path.FullPath,
