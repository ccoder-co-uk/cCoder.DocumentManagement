...
public partial class FileOrchestrationServiceTests
{
    ...
    public async Task ShouldCallProcessingThenRaiseUpdateEventAsyncWhenUpdateAsync()
    {
        ...
        fileProcessingServiceMock.Setup(expression: x => x.UpdateFileAsync(entity: entity))
        ...
        // When
        cCoder.Data.Models.DMS.File result = await orchestrationService.UpdateFileAsync(entity: entity);

        // Then
        result.Should()
            .BeSameAs(expected: entity);

        fileProcessingServiceMock.Verify(expression: x => x.UpdateFileAsync(entity: entity), times: Times.Once);
